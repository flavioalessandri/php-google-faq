...
<div class="container" style="margin:0 auto; max-width:1200px; color: rgba(0,0,0,0.87); font-family: Roboto,arial,sans-serif; font-size: 14px; font-weight: 400; line-height: 1.54;">
 ...
 foreach ($faq as $key => $value) {
  ...
  ?>
    ...
    <h2 style = "color: #3c4043;font-family: 'Google Sans',sans-serif;font-weight: 500; font-size: 24px; line-height: 32px; margin: 0; padding: 64px 0 0 0;">
